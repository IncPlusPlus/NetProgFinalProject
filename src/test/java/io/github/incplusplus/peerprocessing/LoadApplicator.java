...
/**
 * This class is included with the tests but does not follow the test naming style. This is because
 * it is not a test and is merely a scratch-pad for throwing a load at a cluster of slaves.
 */
