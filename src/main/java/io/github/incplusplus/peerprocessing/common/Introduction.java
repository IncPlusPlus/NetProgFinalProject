...
/**
 * A class that gives both parties of a particular communication details
 * about one another. The <i>typical</i> way this is transmitted is in a
 * faux-handshake manner. The initiating partner demands an Introduction
 * from the other partner. That partner sends an Introduction back to
...
public class Introduction {
	/**
	 * The id of the member who sent this Introduction
	 * (if determined; else null)
	 */
	private UUID senderId;
	/**
	 * The id of the member who will receive this Introduction
	 * (if known; else null)
	 */
