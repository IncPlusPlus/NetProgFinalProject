...
/**
 * This class is purely a driver class for a single {@link Client}. Run the main method here to
 * create an instance of a Client and interact with it through the console. <br>
 * The goal of this class is to make the {@link Client} class as object-oriented as possible and
 * avoid using its main method. This also will help with making improving coverage easier.
 */
